...
@Service
@Transactional
public class DraftTypeAccountInfoService {

    private final Logger log = LoggerFactory.getLogger(DraftTypeAccountInfoService.class);
    ...
    public DraftTypeAccountInfoService(
    ...
    /**
     * Partially update a draftTypeAccountInfo.
     *
    ...
    /**
     * Get one draftTypeAccountInfo by id.
     *
    ...
    /**
     * Delete the draftTypeAccountInfo by id.
     *
     * @param id the id of the entity.
     */
