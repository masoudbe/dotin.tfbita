...
/**
 * REST controller for managing {@link com.dotin.tfbita.domain.ProductType}.
 */
@RestController
...
public class ProductTypeResource {
    ...
    public ResponseEntity<ProductTypeDTO> createProductType(@RequestBody ProductTypeDTO productTypeDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/product-types/" + productTypeDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, productTypeDTO.getId().toString()))
            .body(productTypeDTO);
    }
    ...
    public ResponseEntity<ProductTypeDTO> updateProductType(
        ...
        productTypeDTO = productTypeService.update(productTypeDTO);
