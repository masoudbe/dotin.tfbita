...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './additional-broker-information.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADDITIONALBROKERINFORMATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ADDITIONALBROKERINFORMATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ADDITIONALBROKERINFORMATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ADDITIONALBROKERINFORMATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ADDITIONALBROKERINFORMATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ADDITIONALBROKERINFORMATION actions', async () => {
      const arg = 42666;
