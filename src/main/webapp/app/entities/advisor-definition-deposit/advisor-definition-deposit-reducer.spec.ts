...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './advisor-definition-deposit.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADVISORDEFINITIONDEPOSIT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ADVISORDEFINITIONDEPOSIT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ADVISORDEFINITIONDEPOSIT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ADVISORDEFINITIONDEPOSIT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ADVISORDEFINITIONDEPOSIT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ADVISORDEFINITIONDEPOSIT actions', async () => {
      const arg = 42666;
