...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './advisor-definition.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADVISORDEFINITION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ADVISORDEFINITION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ADVISORDEFINITION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ADVISORDEFINITION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ADVISORDEFINITION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ADVISORDEFINITION actions', async () => {
      const arg = 42666;
