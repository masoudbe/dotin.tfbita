...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './attribute-value-group.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ATTRIBUTEVALUEGROUP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ATTRIBUTEVALUEGROUP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ATTRIBUTEVALUEGROUP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ATTRIBUTEVALUEGROUP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ATTRIBUTEVALUEGROUP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ATTRIBUTEVALUEGROUP actions', async () => {
      const arg = 42666;
