...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './audit-company-info.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AUDITCOMPANYINFO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AUDITCOMPANYINFO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AUDITCOMPANYINFO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AUDITCOMPANYINFO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AUDITCOMPANYINFO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AUDITCOMPANYINFO actions', async () => {
      const arg = 42666;
