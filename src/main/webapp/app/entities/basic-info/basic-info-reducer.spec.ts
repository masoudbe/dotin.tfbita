...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BASICINFO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BASICINFO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BASICINFO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BASICINFO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BASICINFO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BASICINFO actions', async () => {
      const arg = 42666;
