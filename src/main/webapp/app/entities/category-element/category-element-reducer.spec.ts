...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CATEGORYELEMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CATEGORYELEMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CATEGORYELEMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CATEGORYELEMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CATEGORYELEMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CATEGORYELEMENT actions', async () => {
      const arg = 42666;
