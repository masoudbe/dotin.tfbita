...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './credit-type-condition-info.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CREDITTYPECONDITIONINFO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CREDITTYPECONDITIONINFO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CREDITTYPECONDITIONINFO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CREDITTYPECONDITIONINFO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CREDITTYPECONDITIONINFO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CREDITTYPECONDITIONINFO actions', async () => {
      const arg = 42666;
