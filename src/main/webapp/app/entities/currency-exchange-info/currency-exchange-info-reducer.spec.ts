...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './currency-exchange-info.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CURRENCYEXCHANGEINFO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CURRENCYEXCHANGEINFO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CURRENCYEXCHANGEINFO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CURRENCYEXCHANGEINFO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CURRENCYEXCHANGEINFO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CURRENCYEXCHANGEINFO actions', async () => {
      const arg = 42666;
