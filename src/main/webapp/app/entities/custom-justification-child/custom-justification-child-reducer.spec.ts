...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './custom-justification-child.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CUSTOMJUSTIFICATIONCHILD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CUSTOMJUSTIFICATIONCHILD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CUSTOMJUSTIFICATIONCHILD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CUSTOMJUSTIFICATIONCHILD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CUSTOMJUSTIFICATIONCHILD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CUSTOMJUSTIFICATIONCHILD actions', async () => {
      const arg = 42666;
