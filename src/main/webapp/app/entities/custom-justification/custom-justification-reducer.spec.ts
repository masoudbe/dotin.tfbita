...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './custom-justification.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CUSTOMJUSTIFICATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CUSTOMJUSTIFICATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CUSTOMJUSTIFICATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CUSTOMJUSTIFICATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CUSTOMJUSTIFICATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CUSTOMJUSTIFICATION actions', async () => {
      const arg = 42666;
