...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './document-transaction.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOCUMENTTRANSACTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DOCUMENTTRANSACTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DOCUMENTTRANSACTION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DOCUMENTTRANSACTION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DOCUMENTTRANSACTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DOCUMENTTRANSACTION actions', async () => {
      const arg = 42666;
