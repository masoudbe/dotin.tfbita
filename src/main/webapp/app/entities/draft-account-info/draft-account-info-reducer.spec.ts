...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './draft-account-info.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DRAFTACCOUNTINFO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DRAFTACCOUNTINFO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DRAFTACCOUNTINFO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DRAFTACCOUNTINFO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DRAFTACCOUNTINFO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DRAFTACCOUNTINFO actions', async () => {
      const arg = 42666;
