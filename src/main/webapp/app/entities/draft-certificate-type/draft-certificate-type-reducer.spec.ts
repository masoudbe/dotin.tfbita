...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './draft-certificate-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DRAFTCERTIFICATETYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DRAFTCERTIFICATETYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DRAFTCERTIFICATETYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DRAFTCERTIFICATETYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DRAFTCERTIFICATETYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DRAFTCERTIFICATETYPE actions', async () => {
      const arg = 42666;
