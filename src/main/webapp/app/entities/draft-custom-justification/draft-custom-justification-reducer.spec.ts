...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './draft-custom-justification.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DRAFTCUSTOMJUSTIFICATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DRAFTCUSTOMJUSTIFICATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DRAFTCUSTOMJUSTIFICATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DRAFTCUSTOMJUSTIFICATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DRAFTCUSTOMJUSTIFICATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DRAFTCUSTOMJUSTIFICATION actions', async () => {
      const arg = 42666;
