...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './draft-document-transaction-container.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DRAFTDOCUMENTTRANSACTIONCONTAINER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DRAFTDOCUMENTTRANSACTIONCONTAINER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DRAFTDOCUMENTTRANSACTIONCONTAINER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DRAFTDOCUMENTTRANSACTIONCONTAINER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DRAFTDOCUMENTTRANSACTIONCONTAINER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DRAFTDOCUMENTTRANSACTIONCONTAINER actions', async () => {
      const arg = 42666;
