...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DRAFTEXTEND_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DRAFTEXTEND actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DRAFTEXTEND actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DRAFTEXTEND actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DRAFTEXTEND actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DRAFTEXTEND actions', async () => {
      const arg = 42666;
