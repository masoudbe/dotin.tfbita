...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DRAFTFACTOR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DRAFTFACTOR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DRAFTFACTOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DRAFTFACTOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DRAFTFACTOR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DRAFTFACTOR actions', async () => {
      const arg = 42666;
