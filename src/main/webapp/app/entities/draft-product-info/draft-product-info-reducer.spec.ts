...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './draft-product-info.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DRAFTPRODUCTINFO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DRAFTPRODUCTINFO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DRAFTPRODUCTINFO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DRAFTPRODUCTINFO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DRAFTPRODUCTINFO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DRAFTPRODUCTINFO actions', async () => {
      const arg = 42666;
