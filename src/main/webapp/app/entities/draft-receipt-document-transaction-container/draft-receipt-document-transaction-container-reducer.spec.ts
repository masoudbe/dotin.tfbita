...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './draft-receipt-document-transaction-container.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DRAFTRECEIPTDOCUMENTTRANSACTIONCONTAINER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DRAFTRECEIPTDOCUMENTTRANSACTIONCONTAINER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DRAFTRECEIPTDOCUMENTTRANSACTIONCONTAINER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DRAFTRECEIPTDOCUMENTTRANSACTIONCONTAINER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DRAFTRECEIPTDOCUMENTTRANSACTIONCONTAINER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DRAFTRECEIPTDOCUMENTTRANSACTIONCONTAINER actions', async () => {
      const arg = 42666;
