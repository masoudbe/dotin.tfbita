...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DRAFTRECEIPT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DRAFTRECEIPT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DRAFTRECEIPT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DRAFTRECEIPT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DRAFTRECEIPT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DRAFTRECEIPT actions', async () => {
      const arg = 42666;
