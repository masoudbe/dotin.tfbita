...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './draft-request-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DRAFTREQUESTTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DRAFTREQUESTTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DRAFTREQUESTTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DRAFTREQUESTTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DRAFTREQUESTTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DRAFTREQUESTTYPE actions', async () => {
      const arg = 42666;
