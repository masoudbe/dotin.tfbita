...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './draft-status-info.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DRAFTSTATUSINFO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DRAFTSTATUSINFO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DRAFTSTATUSINFO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DRAFTSTATUSINFO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DRAFTSTATUSINFO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DRAFTSTATUSINFO actions', async () => {
      const arg = 42666;
