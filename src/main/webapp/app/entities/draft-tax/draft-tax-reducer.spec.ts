...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './draft-tax.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DRAFTTAX_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DRAFTTAX actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DRAFTTAX actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DRAFTTAX actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DRAFTTAX actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DRAFTTAX actions', async () => {
      const arg = 42666;
