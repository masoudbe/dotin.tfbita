...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './draft-type-account-info.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DRAFTTYPEACCOUNTINFO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DRAFTTYPEACCOUNTINFO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DRAFTTYPEACCOUNTINFO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DRAFTTYPEACCOUNTINFO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DRAFTTYPEACCOUNTINFO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DRAFTTYPEACCOUNTINFO actions', async () => {
      const arg = 42666;
