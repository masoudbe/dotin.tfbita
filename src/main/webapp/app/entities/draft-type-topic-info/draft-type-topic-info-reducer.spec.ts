...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './draft-type-topic-info.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DRAFTTYPETOPICINFO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DRAFTTYPETOPICINFO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DRAFTTYPETOPICINFO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DRAFTTYPETOPICINFO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DRAFTTYPETOPICINFO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DRAFTTYPETOPICINFO actions', async () => {
      const arg = 42666;
