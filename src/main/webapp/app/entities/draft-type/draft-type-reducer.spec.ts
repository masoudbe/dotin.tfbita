...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DRAFTTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DRAFTTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DRAFTTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DRAFTTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DRAFTTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DRAFTTYPE actions', async () => {
      const arg = 42666;
