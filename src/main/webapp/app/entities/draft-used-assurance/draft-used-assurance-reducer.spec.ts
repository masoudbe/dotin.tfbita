...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './draft-used-assurance.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DRAFTUSEDASSURANCE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DRAFTUSEDASSURANCE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DRAFTUSEDASSURANCE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DRAFTUSEDASSURANCE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DRAFTUSEDASSURANCE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DRAFTUSEDASSURANCE actions', async () => {
      const arg = 42666;
