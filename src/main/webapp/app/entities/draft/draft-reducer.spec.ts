...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './draft.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DRAFT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DRAFT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DRAFT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DRAFT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DRAFT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DRAFT actions', async () => {
      const arg = 42666;
