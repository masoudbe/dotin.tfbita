...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './insurance-company-info.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INSURANCECOMPANYINFO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INSURANCECOMPANYINFO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INSURANCECOMPANYINFO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INSURANCECOMPANYINFO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INSURANCECOMPANYINFO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INSURANCECOMPANYINFO actions', async () => {
      const arg = 42666;
