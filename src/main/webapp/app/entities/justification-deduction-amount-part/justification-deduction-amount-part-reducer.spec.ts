...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './justification-deduction-amount-part.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JUSTIFICATIONDEDUCTIONAMOUNTPART_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_JUSTIFICATIONDEDUCTIONAMOUNTPART actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_JUSTIFICATIONDEDUCTIONAMOUNTPART actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_JUSTIFICATIONDEDUCTIONAMOUNTPART actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_JUSTIFICATIONDEDUCTIONAMOUNTPART actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_JUSTIFICATIONDEDUCTIONAMOUNTPART actions', async () => {
      const arg = 42666;
