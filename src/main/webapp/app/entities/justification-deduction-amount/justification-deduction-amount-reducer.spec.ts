...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './justification-deduction-amount.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JUSTIFICATIONDEDUCTIONAMOUNT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_JUSTIFICATIONDEDUCTIONAMOUNT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_JUSTIFICATIONDEDUCTIONAMOUNT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_JUSTIFICATIONDEDUCTIONAMOUNT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_JUSTIFICATIONDEDUCTIONAMOUNT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_JUSTIFICATIONDEDUCTIONAMOUNT actions', async () => {
      const arg = 42666;
