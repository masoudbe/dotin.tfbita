...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './justification-deduction-detail.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JUSTIFICATIONDEDUCTIONDETAIL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_JUSTIFICATIONDEDUCTIONDETAIL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_JUSTIFICATIONDEDUCTIONDETAIL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_JUSTIFICATIONDEDUCTIONDETAIL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_JUSTIFICATIONDEDUCTIONDETAIL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_JUSTIFICATIONDEDUCTIONDETAIL actions', async () => {
      const arg = 42666;
