...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LICENCEINFO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LICENCEINFO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LICENCEINFO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LICENCEINFO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LICENCEINFO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LICENCEINFO actions', async () => {
      const arg = 42666;
