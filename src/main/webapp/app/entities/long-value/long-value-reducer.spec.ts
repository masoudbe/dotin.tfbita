...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LONGVALUE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LONGVALUE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LONGVALUE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LONGVALUE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LONGVALUE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LONGVALUE actions', async () => {
      const arg = 42666;
