...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './objective-category-element.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OBJECTIVECATEGORYELEMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OBJECTIVECATEGORYELEMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OBJECTIVECATEGORYELEMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_OBJECTIVECATEGORYELEMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_OBJECTIVECATEGORYELEMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OBJECTIVECATEGORYELEMENT actions', async () => {
      const arg = 42666;
