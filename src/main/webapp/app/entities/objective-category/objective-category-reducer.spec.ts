...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './objective-category.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OBJECTIVECATEGORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OBJECTIVECATEGORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OBJECTIVECATEGORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_OBJECTIVECATEGORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_OBJECTIVECATEGORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OBJECTIVECATEGORY actions', async () => {
      const arg = 42666;
