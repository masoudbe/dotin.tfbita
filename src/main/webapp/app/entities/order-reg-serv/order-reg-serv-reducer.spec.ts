...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORDERREGSERV_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ORDERREGSERV actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ORDERREGSERV actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ORDERREGSERV actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ORDERREGSERV actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ORDERREGSERV actions', async () => {
      const arg = 42666;
