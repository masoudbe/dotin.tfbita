...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './order-reg-service.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORDERREGSERVICE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ORDERREGSERVICE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ORDERREGSERVICE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ORDERREGSERVICE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ORDERREGSERVICE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ORDERREGSERVICE actions', async () => {
      const arg = 42666;
