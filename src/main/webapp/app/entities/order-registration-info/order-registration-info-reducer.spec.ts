...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './order-registration-info.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORDERREGISTRATIONINFO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ORDERREGISTRATIONINFO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ORDERREGISTRATIONINFO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ORDERREGISTRATIONINFO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ORDERREGISTRATIONINFO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ORDERREGISTRATIONINFO actions', async () => {
      const arg = 42666;
