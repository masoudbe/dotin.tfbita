...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './payment-condition.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYMENTCONDITION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PAYMENTCONDITION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PAYMENTCONDITION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PAYMENTCONDITION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PAYMENTCONDITION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PAYMENTCONDITION actions', async () => {
      const arg = 42666;
