...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './payment-currency-rate-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYMENTCURRENCYRATETYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PAYMENTCURRENCYRATETYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PAYMENTCURRENCYRATETYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PAYMENTCURRENCYRATETYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PAYMENTCURRENCYRATETYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PAYMENTCURRENCYRATETYPE actions', async () => {
      const arg = 42666;
