...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './payment-item-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYMENTITEMTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PAYMENTITEMTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PAYMENTITEMTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PAYMENTITEMTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PAYMENTITEMTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PAYMENTITEMTYPE actions', async () => {
      const arg = 42666;
