...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './purchase-from-other-resources.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PURCHASEFROMOTHERRESOURCES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PURCHASEFROMOTHERRESOURCES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PURCHASEFROMOTHERRESOURCES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PURCHASEFROMOTHERRESOURCES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PURCHASEFROMOTHERRESOURCES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PURCHASEFROMOTHERRESOURCES actions', async () => {
      const arg = 42666;
