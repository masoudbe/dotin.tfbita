...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SERVICETARIFF_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SERVICETARIFF actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SERVICETARIFF actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SERVICETARIFF actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SERVICETARIFF actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SERVICETARIFF actions', async () => {
      const arg = 42666;
