...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STRINGVALUE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STRINGVALUE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STRINGVALUE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_STRINGVALUE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_STRINGVALUE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STRINGVALUE actions', async () => {
      const arg = 42666;
