...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './suggested-sanction-info.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUGGESTEDSANCTIONINFO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SUGGESTEDSANCTIONINFO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SUGGESTEDSANCTIONINFO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SUGGESTEDSANCTIONINFO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SUGGESTEDSANCTIONINFO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SUGGESTEDSANCTIONINFO actions', async () => {
      const arg = 42666;
