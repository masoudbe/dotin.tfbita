...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './swift-bic.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SWIFTBIC_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SWIFTBIC actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SWIFTBIC actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SWIFTBIC actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SWIFTBIC actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SWIFTBIC actions', async () => {
      const arg = 42666;
