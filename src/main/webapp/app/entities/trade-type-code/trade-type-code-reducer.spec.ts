...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRADETYPECODE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TRADETYPECODE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TRADETYPECODE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TRADETYPECODE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TRADETYPECODE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TRADETYPECODE actions', async () => {
      const arg = 42666;
