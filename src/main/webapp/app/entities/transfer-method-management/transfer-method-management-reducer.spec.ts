...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './transfer-method-management.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRANSFERMETHODMANAGEMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TRANSFERMETHODMANAGEMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TRANSFERMETHODMANAGEMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TRANSFERMETHODMANAGEMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TRANSFERMETHODMANAGEMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TRANSFERMETHODMANAGEMENT actions', async () => {
      const arg = 42666;
