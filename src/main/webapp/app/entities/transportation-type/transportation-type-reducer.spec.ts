...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './transportation-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRANSPORTATIONTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TRANSPORTATIONTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TRANSPORTATIONTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TRANSPORTATIONTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TRANSPORTATIONTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TRANSPORTATIONTYPE actions', async () => {
      const arg = 42666;
