...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TYPEATTRIBUTE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TYPEATTRIBUTE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TYPEATTRIBUTE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TYPEATTRIBUTE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TYPEATTRIBUTE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TYPEATTRIBUTE actions', async () => {
      const arg = 42666;
