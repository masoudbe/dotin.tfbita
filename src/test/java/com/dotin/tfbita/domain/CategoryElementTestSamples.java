...
public class CategoryElementTestSamples {
    ...
    public static CategoryElement getCategoryElementSample1() {
        return new CategoryElement().id(1L).value("value1").categoryName("categoryName1").code("code1");
    }

    public static CategoryElement getCategoryElementSample2() {
        return new CategoryElement().id(2L).value("value2").categoryName("categoryName2").code("code2");
    }
